...
# Features
It can contains both *categorical and numerical data*
It is suitable for *classification problems*
It includes *real world banking attributes*
It can be used for *machine learning and data analysis projects*
